    ...
    with open(join(mypath, "wtw-" + date + ".MD"), "w") as mdfile:
        ...
        for col in ["flag","downvote"]:
            ...
            for by in ["flagger","flaggee"]:
                ...
                mdfile.write("</TABLE>\n")
        mdfile.write("<H4>Life-feed</H4>")
        mdfile.write("Click the below image to view a life feed of incoming flags.<br>")
        mdfile.write('<A HREF="http://steem-flags.timelord.ninja/"><IMG SRC="https://cdn.steemitimages.com/DQmcz5KzyF2sDf19HJR82sk5eQjcZ4CPRRTUBZxhH4WfwHo/image.png"></A><br>')
        mdfile.write('Both the life-feed page and this daily post are generated by open source asyncsteem scripts ')
        mdfile.write('that cn be found in the *sample_code* directory of the <A HREF="https://github.com/pibara-utopian/asyncsteem">asyncsteem repo</A>.')
        mdfile.write("Feature suggestions, bug reports and pull reuests are very much welcomed if submitted as issue.")
        mdfile.write("If you do submit an issue on github, please also consider making an @utopian-io contribution using one of the following templates:<ul>")
        mdfile.write('<li><A HREF="https://github.com/utopian-io/editor-templates/blob/master/ideas">ideas</A></li>')
        mdfile.write('<li><A HREF="https://github.com/utopian-io/editor-templates/blob/master/bug-hunting">bug-hunting</A></li>')
        mdfile.write('<li><A HREF="https://github.com/utopian-io/editor-templates/blob/master/analysis">analysis</A></li>')
        mdfile.write("</ul><br>")
        mdfile.write("If you submit a pull request and it gets accepted into asyncsteem, then consider a utopian submission using this template:<ul>")
        mdfile.write('<li><A HREF="https://github.com/utopian-io/editor-templates/blob/master/development">development</A></li>')
        mdfile.write("</ul><br>")
